...
!function () {
    ...
    function t() {
        function e(e) {
            e = e || {},
                ...
                ;
            var l, T, i, n, t, U, r, H, a, o = Object.assign({}, l), u = [], s = "./this.program", c = (e, n) => {
                throw n
            }
                , k = "object" == typeof window, f = "function" == typeof importScripts, L = "object" == typeof process && "object" == typeof process.versions && "string" == typeof process.versions.node, p = "", q = (L ? (p = f ? require("path").dirname(p) + "/" : __dirname + "/",
                    H = () => {
                        r || (U = require("fs"),
                            r = require("path"))
                    }
                ...
                ) : (k || f) && (f ? p = self.location.href : "undefined" != typeof document && document.currentScript && (p = document.currentScript.src),
                    p = 0 !== (p = Te ? Te : p).indexOf("blob:") ? p.substr(0, p.replace(/[?#].*/, "").lastIndexOf("/") + 1) : "",
                    n = e => {
                    ...
                    l.print || console.log.bind(console)), m = l.printErr || console.warn.bind(console), d = (Object.assign(l, o),
            ...
            var W, B, h, y, g, N, v = !1, K = "undefined" != typeof TextDecoder ? new TextDecoder("utf8") : void 0;
            function X(e, n, t) {
                var r = n + t;
                for (t = n; e[t] && !(r <= t);)
                    ++t;
                ...
                for (r = ""; n < t;) {
                    var o, i, a = e[n++];
                    128 & a ? (o = 63 & e[n++],
                        192 == (224 & a) ? r += String.fromCharCode((31 & a) << 6 | o) : (i = 63 & e[n++],
                            (a = 224 == (240 & a) ? (15 & a) << 12 | o << 6 | i : (7 & a) << 18 | o << 12 | i << 6 | 63 & e[n++]) < 65536 ? r += String.fromCharCode(a) : (a -= 65536,
            ...
            var w, $ = [], Q = [], ee = [], ne = [], te = !1, _ = 0, b = 0, re = null, S = null;
            function A(e) {
                throw l.onAbort && l.onAbort(e),
                m(e = "Aborted(" + e + ")"),
                v = !0,
            ...
            l.preloadedImages = {},
                ...
                w = "stockfish.wasm",
                oe() || (o = w,
                    w = l.locateFile ? l.locateFile(o, p) : p + o);
            var ae = {
                6672168: function () {
                    try {
                        l.onDoneSearching()
            ...
            function D(e) {
                for (; 0 < e.length;) {
                    var n, t = e.shift();
                    "function" == typeof t ? t(l) : "number" == typeof (n = t.S) ? void 0 === t.P ? Ie.call(null, n) : Ee.apply(null, [n, t.P]) : n(void 0 === t.P ? null : t.P)
                }
            }
            function ue(e) {
            ...
            function x(e, n) {
                for (e = new Date(e.getTime()); 0 < n;) {
                    ...
                    n -= r - e.getDate() + 1,
                        e.setDate(1),
                        t < 11 ? e.setMonth(t + 1) : (e.setMonth(0),
            ...
            function ge(e, n, t, r) {
                ...
                var l, p, m = "Sunday Monday Tuesday Wednesday Thursday Friday Saturday".split(" "), d = "January February March April May June July August September October November December".split(" "), f = {
                    "%a": function (e) {
                    ...
                    "%U": function (e) {
                        ...
                        return a(t, e = new Date(e.A + 1900, e.K, e.L)) < 0 ? i(Math.ceil((31 - t.getDate() + (ye(C(e.getFullYear()) ? M : R, e.getMonth() - 1) - 31) + e.getDate()) / 7), 2) : 0 === a(t, n) ? "01" : "00"
                    },
                    "%V": function (e) {
                        ...
                        return a(r, t) < 0 ? "53" : a(n, r) <= 0 ? "01" : i(Math.ceil((t.getFullYear() < e.A + 1900 ? e.O + 32 - t.getDate() : e.O + 1 - t.getDate()) / 7), 2)
                    },
                    "%w": function (e) {
                        return e.N
                    },
                ...
                for (c in t = t.replace(/%%/g, "\0\0"),
                    f)
                    t.includes(c) && (t = t.replace(new RegExp(c, "g"), f[c](r)));
                return t = t.replace(/\0\0/g, "%"),
                    l = t,
                    p = Array(V(l) + 1),
                    G(l, p, 0, p.length),
                    (c = p).length > n ? 0 : (h.set(c, e),
                        c.length - 1)
            }
            function F(e) {
                try {
                    ...
                    !function (e) {
                        ...
                        r[e] = "function" == typeof n ? function () {
                            ...
                            try {
                                ...
                                v || (I.pop() !== e && A(void 0),
                                    E && 1 === O && 0 === I.length && (O = 0,
                                        F(l._asyncify_stop_unwind),
                                        "undefined" != typeof Fibers) && Fibers.aa())
                            }
                        }
                            : n
                    }(e);
            ...
            function De(e) {
                ...
                v || (0 === O ? (i = o = !1,
                    ...
                    o || (O = 1,
                        ...
                        "undefined" != typeof Browser && Browser.R.S && Browser.R.pause())) : 2 === O ? (O = 0,
                            F(l._asyncify_stop_rewind),
                            Me(E),
                            E = null,
                            Se.forEach(e => pe(e))) : A("invalid state: " + O))
            }
            var P, Ce = {
                d: function () {
                    return 0
                ...
                c: function (e) {
                    ...
                    if (!(2147483648 < (e >>>= 0)))
                        for (var t = 1; t <= 4; t *= 2) {
                            ...
                            e: {
                                try {
                                    W.grow(o - B.byteLength + 65535 >>> 16),
                                        Z();
                                    var i = 1;
                                    break e
                                } catch (e) { }
                ...
                n: function (r, o) {
                    var i = 0;
                    return he().forEach(function (e, n) {
                        var t = o + i;
                        for (n = g[r + 4 * n >> 2] = t,
                            t = 0; t < e.length; ++t)
                ...
                function r(e) {
                    return (a || !k && !f || "function" != typeof fetch ? Promise.resolve().then(ie) : fetch(w, {
                        credentials: "same-origin"
                    }).then(function (e) {
                        if (e.ok)
                            return e.arrayBuffer();
                        throw "failed to load wasm binary file at '" + w + "'"
                    }).catch(ie)).then(function (e) {
                ...
                (a || "function" != typeof WebAssembly.instantiateStreaming || oe() || "function" != typeof fetch ? r(t) : fetch(w, {
                    credentials: "same-origin"
                }).then(function (e) {
                    ...
                    if (l.preRun)
                        for ("function" == typeof l.preRun && (l.preRun = [l.preRun]); l.preRun.length;)
                            n = void 0,
                                ...
                                $.unshift(n);
                    D($),
                        0 < b || (l.setStatus ? (l.setStatus("Running..."),
                            setTimeout(function () {
                                setTimeout(function () {
                                    l.setStatus("")
                                }, 1),
            ...
            function Ye(e) {
                d || 0 < _ || (te = !0),
                    d || 0 < _ || (l.onExit && l.onExit(e),
                        v = !0),
                    c(e, new j(e))
            }
            if (l._asyncify_start_unwind = function () {
                ...
                l.ccall = function (e, n, t, r, o) {
                    ...
                    var a = {
                        string: function (e) {
                            var n, t = 0;
                            return null != e && 0 !== e && (n = 1 + (e.length << 2),
                                t = Y(n),
                                G(e, y, t, n)),
                                t
                        },
    ...
    function i(e) {
        if (r.ccall("command", null, ["string"], [e], {
    ...
    function l() {
        ...
        var t;
        "undefined" == typeof IS_ASYNCIFY ? r.onDoneSearching = c : r.onDoneSearching = function () {
            setTimeout(c, 1)
        }
            ,
            r.processCommand = f,
    ...
    function p(t) {
        var e, r = 0, o = [], n = a.slice(1 + (a.lastIndexOf(".") - 1 >>> 0)), i = a.slice(0, -n.length);
        for (e = 0; e < t; ++e)
            !function (e, n) {
                ...
                return function (e) {
                    ++r,
                        o[n] = e,
                        r === t && (e = URL.createObjectURL(new Blob(o, {
    ...
    "undefined" != typeof self && "worker" === self.location.hash.split(",")[1] || "undefined" != typeof global && "[object process]" === Object.prototype.toString.call(global.process) && !require("worker_threads").isMainThread || ("undefined" != typeof onmessage && ("undefined" == typeof window || void 0 === window.document) || "undefined" != typeof global && "[object process]" === Object.prototype.toString.call(global.process) ? (e = "undefined" != typeof global && "[object process]" === Object.prototype.toString.call(global.process),
        ...
        o = [],
        n = [],
        e ? require.main === module ? (s = require("path"),
            ...
            "number" == typeof enginePartsCount && (r.wasmBinary = function (e) {
            ...
            require("readline").createInterface({
                ...
                e && (r.processCommand ? r.processCommand(e) : o.push(e),
                    "quit" === e) && process.exit()
            }).on("close", function () {
                process.exit()
            }).setPrompt("")) : module.exports = t : (e = self.location.hash.substr(1).split(","),
                ...
                onmessage = onmessage || function (e) {
                    if (r.processCommand ? r.processCommand(e.data) : o.push(e.data),
                        "quit" === e.data)
                        try {
                            self.close()
                        } catch (e) { }
